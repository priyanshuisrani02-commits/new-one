...
export const JournalPage = () => {
  ...
  useEffect(() => {
    if (!liveOpen) return;
    const channel = supabase.channel('live-journal-messages').on('postgres_changes', { event: 'INSERT', schema: 'public', table: 'live_journal_messages' }, (payload) => {
