...
.book-stage.opening .book-cover{animation:coverOpen 2.35s cubic-bezier(.18,.72,.15,1) forwards}
.book-stage.opening .book-pages{animation:innerBook 1.05s 1.05s cubic-bezier(.2,.8,.2,1) forwards}
